...
export default defineVuesticConfig({
	...
	components: {
		...
		VaDataTable: {
			...
			style: `
				--va-data-table-thead-font-size: 0.875rem;
				--va-data-table-tbody-font-size: 0.875rem;
			`,
		},
		presets: {
			VaSelect: {
				small: {
					...
					width: 'min(100%, 150px)',
					style: '--va-input-wrapper-min-height: 24px; --va-input-wrapper-border-radius: 2px; --va-input-wrapper-width: 100px;',
				},
			},
		},
	},
